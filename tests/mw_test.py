import unittest
from mw import mnemonic_to_master, compute_address
...
class TestAll(unittest.TestCase):
    def test_eth(self):
        ...
        self.assertEqual(a0, '98cf7199f4e0c977196aafa64c6a240febb7b73e')
        self.assertEqual(p0, 'adc79901d8f7c56ff3ce1ea64ef09b17dcc9c246d5ca4e8cae5aace46471e8ee')
        (a10, p10) = compute_address('eth', master, 10)
        self.assertEqual(a10, '07384028cc968f0023324661599a234051ad99f9')
        self.assertEqual(p10, '6d8e2c2a53f5e918565ca9cb000ecacaeb87bddbf60a8fbe450f1f576e5e1b4a')
    def test_btc(self):
        (seed, master) = mnemonic_to_master(mnemonic2, 'TREZOR')
        self.assertEquals(hexlify(seed), 'c55257c360c07c72029aebc1b53c05ed0362ada38ead3e3e9efa3708e53495531f09a6987599d18264c1e1c92f2cf141630c7a3c4ab7c81b2f001698e7463b04')
